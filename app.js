...
javascript:(function () { var script = document.createElement('script'); script.src="[//link to our script]"; document.body.appendChild(script); script.onload = function () { TMPInit({'body':'','input':''}) } })();
